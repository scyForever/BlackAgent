"""Investigation runtime phase and helper methods.

This module keeps the heavy runtime mechanics outside the public
``InvestigationRuntime`` shell so orchestration can depend on explicit services
while retaining backwards-compatible helper methods for existing callers/tests.
"""
...
class InvestigationRuntimeMixin:
    """Backwards-compatible runtime phase helpers used by injected services."""
