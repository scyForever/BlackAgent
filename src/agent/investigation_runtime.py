...
from src.workflows import InvestigationWorkflow, WorkflowContext
...
class InvestigationRuntime:
    """Runtime implementation behind the thin public orchestrator wrapper."""
    ...
    def __init__(
        ...
        *,
        ...
        self.workflow = InvestigationWorkflow(self)
...
__all__ = ["InvestigationRuntime", "InvestigationRunResult"]
